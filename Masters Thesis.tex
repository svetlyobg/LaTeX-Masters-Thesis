...
\begin{document}
	...
	\include{abstract/Introduction.tex}{Въведение}\label{Abstr}
	%\input{abstract}
	\newpage
	
	\include{chapters/Virtual machines.tex}{Виртуални машини}\label{Sect1}
	%\input{Section1}
	\newpage
	
	\include{chapters/Previous infrastructure, research and preparation.tex}{Предишна инфраструктура, изследване и подготовка}\label{Sect2}
	%\input{Section2}
	\newpage
	
	\include{chapters/New Infrastructure Requirements.tex}{Изисквания за нова инфраструктура}\label{Sect3}
	%\input{Section3}
	\newpage
	
	\include{chapters/Designing of the New Infrastructure.tex}{Проектиране на нова инфраструктура}\label{Sect4}
	%\input{Section4}
	\newpage
	
	\include{abstract/Glossary of Terms.tex}{Речник на термини}\label{Sect5}
	%\input{Section5}
	\newpage
